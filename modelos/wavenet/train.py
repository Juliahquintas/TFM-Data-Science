...
from model import WaveNetClassifier
...
def main():
    ...
    _net_tmp  = WaveNetClassifier(TARGET_SAMPLES, cfg.NHID, cfg.KERNEL_SIZE, cfg.DROPOUT)
    ...
    for fold_idx in range(1, cfg.K_FOLDS + 1):
        ...
        net = WaveNetClassifier(TARGET_SAMPLES, cfg.NHID,
